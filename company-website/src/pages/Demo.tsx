          ...
          <div className="absolute top-4 right-4 z-40 max-w-sm">
            <div className="bg-card border border-border rounded-lg p-4 shadow-lg">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm font-semibold text-foreground">Live Demo Guide</h3>
                <button className="text-muted-foreground hover:text-foreground" onClick={() => setShowGuide(false)}>✕</button>
              </div>
              <ul className="text-xs text-muted-foreground space-y-1">
                <li>• Allow camera access when prompted</li>
                <li>• Stand near an object to test detection</li>
                <li>• Look for “System Active” when demo is ready</li>
                <li>• Expect proactive guidance prompts</li>
              </ul>
            </div>
          </div>
        )}
