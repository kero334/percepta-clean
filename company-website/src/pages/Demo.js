...
export default function Demo() {
    ...
    return (_jsxs("div", { className: "min-h-screen flex flex-col bg-background overflow-x-hidden", children: [_jsx(Navigation, {}), _jsxs("main", { className: "flex-1 pt-16 relative overflow-x-hidden", children: [showGuide && (_jsx("div", { className: "absolute top-4 right-4 z-40 max-w-sm", children: _jsxs("div", { className: "bg-card border border-border rounded-lg p-4 shadow-lg", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("h3", { className: "text-sm font-semibold text-foreground", children: "Live Demo Guide" }), _jsx("button", { className: "text-muted-foreground hover:text-foreground", onClick: () => setShowGuide(false), children: "\u2715" })] }), _jsxs("ul", { className: "text-xs text-muted-foreground space-y-1", children: [_jsx("li", { children: "\u2022 Allow camera access when prompted" }), _jsx("li", { children: "\u2022 Stand near an object to test detection" }), _jsx("li", { children: "\u2022 Look for \u201CSystem Active\u201D when demo is ready" }), _jsx("li", { children: "\u2022 Expect proactive guidance prompts" })] })] }) })), iframeError && (_jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-background p-8", children: _jsxs("div", { className: "text-center", children: [_jsx("p", { className: "text-destructive mb-4", children: "Failed to load demo" }), _jsx("button", { onClick: () => {
                                        setIframeError(false);
                                        window.location.reload();
                                    }, className: "px-4 py-2 bg-primary text-primary-foreground rounded", children: "Retry" })] }) })), !loaded && !iframeError && (_jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "w-12 h-12 rounded-full border-4 border-muted border-t-primary animate-spin mx-auto mb-4" }), _jsx("p", { className: "text-muted-foreground", children: "Initializing demo..." })] }) })), _jsx("iframe", { src: "/percepta/index.html", className: "w-full h-[calc(100dvh-4rem)] border-0", title: "Percepta AI Live Demo", allow: "camera; microphone", sandbox: "allow-scripts allow-same-origin allow-forms allow-popups allow-modals allow-downloads", loading: "eager", ref: iframeRef, onLoad: () => {
                            setLoaded(true);
                            fetch("/api/analytics", {
                                method: "POST",
                                headers: { "Content-Type": "application/json" },
