    ...
    const materials = [
        {
            ...
            contentType: "pdf",
            url: "https://files.percepta.ai/overview.pdf",
        },
        {
            _id: "mat-2",
            title: "Live Demo Walkthrough (Video)",
        ...
        },
        {
            ...
            url: "https://files.percepta.ai/technical-deck.html",
        },
    ];
    const getIcon = (type) => {
        switch (type) {
